...
def selects_all_female_bears_return_name_and_age
  ...
  # 错：TABLE BEARS SELECT GENDER = "F" RETURN BEAR.NAME, BEAR.AGE
end
...
def counts_number_of_bears_with_goofy_temperaments
  ...
  #"SELECT bears.temperament FROM bears WHERE bears.temperament='goofy' COUNT(bears.temperament) "
...
# SELECT is just whatever you want to return